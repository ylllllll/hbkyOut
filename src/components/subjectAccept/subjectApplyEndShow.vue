    ...
    <div id="subjectApplyEndShow">
        ...
        <div class="showForm">
            <el-form ref="showForm" :model="showForm">
                ...
                <!-- 需要网上传专家评审表 step3 -->
                <div class="step3" v-if="showForm.acceptancePhaseId>=6">
                    <p>上传家评审</p>
                    <table class="form_table">
                        <thead>
                    ...
                    <table class="form_table1">
                        <tbody>
                            ...
                            <tr v-for="(item,index) in showForm.extranetExpertGroupComment.extranetExpertGroupCommentsNameList">
                ...
                <!-- 提交 课题验收证书 step4-->
                <div class="step4" v-if="showForm.acceptancePhaseId>=8">
                    <p>江苏省环保科研课题验收证书</p>
                    <table class="form_table">
                        <thead>
                    ...
                    <table class="form_table1">
                        <tbody>
                            ...
                            <tr v-for="(item,index) in showForm.acceptanceCertificate.acceptanceCertificateSubjectPeopleList">
                                <td>
                                    <el-input 
                                    disabled
                ...
                <!-- 审核流程 -->
                <table v-show="showForm.extranetCheckApplyStateList.length>0" class="audit_process">
                    <tbody>
                        <tr>
                            <td>交办人</td>
                            <td>处理人</td>
...
export default {
    ...
    methods:{
        ...
        // 审核通过中的确认
        handleConfirm(){
            let specialAuditFile=document.getElementById('specialAuditFile').files[0]
            let firstInspectionFile=document.getElementById('firstInspectionFile').files[0]
            if(specialAuditFile == undefined || firstInspectionFile == undefined){
                this.$alert('请上传附件', '提示', {
            ...
            this.submitFiles(specialAuditFile,firstInspectionFile)
        },
        // 审核确认之后提交文件
        submitFiles(specialAuditFile,firstInspectionFile){
            let _this = this
            let _id = _this.paramsData.id
            let formData = new FormData()
            formData.append('id',_id)
            formData.append('type',true)
            formData.append('specialAuditFile',specialAuditFile)
