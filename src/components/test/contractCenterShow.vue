<template>
    <div id="contractCenterShow">
        <div class="showForm">
            <el-form ref="showForm" >
                <table class="form_table" :model="showForm">
                    <thead>
                        <tr><th colspan="4">{{ paramsData.id }}合同中心详情页</th></tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>课题类别：</td>
            ...
            <el-button type="primary" v-show="paramsData.state == 'notShowPage'" @click="handleAudite">审核</el-button>
            <el-button type="primary" v-show="paramsData.state == 'notShowPage'" @click="handleNotAudite">退回</el-button>
