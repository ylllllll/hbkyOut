<template>
    <div id="biddingRecordShow">
        <div class="showForm">
            <el-form ref="showForm" :model="showForm" >
                <table class="form_table">
                    <thead>
                        <tr><th colspan="4">{{ paramsData.id }}招标备案详情页</th></tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>项目名称：</td>
            ...
            <div class="btn_group">
                <el-button type="primary" v-show="paramsData.state == 'notShowPage'" @click = "handleExamine">审批</el-button>
                <el-button type="primary" v-show="paramsData.state == 'notShowPage'" @click = "handleNotExamine">退回</el-button>
